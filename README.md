...
**Repozytorium:** [github.com/salva870/lokalizacje](https://github.com/salva870/lokalizacje)  
**Produkcja:** [loc.divotikids.pl](https://loc.divotikids.pl) — kod na serwerze w `/root/lokalizacje`, kontener `lokalizacje-app` (port **3010**).
...
## Wdrożenie / aktualizacja na serwerze
...
Po zmianach lokalnych — commit i push do [salva870/lokalizacje](https://github.com/salva870/lokalizacje):

```bash
git add -A && git status   # upewnij się, że .env nie trafia do commita
git commit -m "opis zmiany"
git push origin main
```

Szczegóły produkcji: `CHANGELOG-SERVER.md`, `DOKUMENTACJA.md`.
